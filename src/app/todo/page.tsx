...
export default function todo() {
  return (
    <section className='bg-principal-light h-[calc(100vh-(80px))] rounded-t-3xl px-8 py-6'>
      <h1>Todo List</h1>
      <div>
        <label className='block' htmlFor="task">Adcionar atividade:</label>
        <div className='relative'>
        <input type="text" id='task' className='w-[80%] h-[30px] rounded-l-xl align-center pl-2 mt-2 border-y-2 border-principal-dark'/>
